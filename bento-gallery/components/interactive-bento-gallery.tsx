    ...
    return (
        <div className="container mx-auto px-2 sm:px-4 py-4 sm:py-8 max-w-4xl">
            <div className="mb-4 sm:mb-8 text-center">
                <motion.h1
                    className="text-xl sm:text-2xl md:text-4xl font-bold bg-clip-text text-transparent 
                ...
                <motion.p
                    className="mt-1 sm:mt-2 text-xs sm:text-sm md:text-base text-gray-600 dark:text-gray-400"
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
            ...
            <AnimatePresence mode="wait">
                {selectedItem ? (
                    ...
                    <motion.div
                        className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-2 sm:gap-3 auto-rows-[40px] sm:auto-rows-[60px]"
                        initial="hidden"
                        animate="visible"
                        exit="hidden"
                        variants={{
                    ...
                    >
                        {items.map((item, index) => (
                            ...
                            >
                                ...
                                />
                                <motion.div
                                    className="absolute inset-0 flex flex-col justify-end p-1.5 xs:p-2 sm:p-3 md:p-4"
                                    initial={{ opacity: 0 }}
                                    whileHover={{ opacity: 1 }}
                                    transition={{ duration: 0.2 }}
                                >
                                    <div className="absolute inset-0 flex flex-col justify-end p-1.5 xs:p-2 sm:p-3 md:p-4">
                                        <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/40 to-transparent" />
                                        <h3 className="relative text-white text-[10px] xs:text-xs sm:text-sm md:text-base font-medium line-clamp-1">
                                            {item.title}
                                        </h3>
                                        <p className="relative text-white/70 text-[8px] xs:text-[10px] sm:text-xs md:text-sm mt-0.5 line-clamp-1 sm:line-clamp-2">
                                            {item.desc}
                                        </p>
                                    </div>
                                </motion.div>
